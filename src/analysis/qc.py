    ...
    def collect_run_metadata(
        ...
        return {
            ...
            "parameters": {
                ...
                "min_distance_from_end": self.config.quality.min_distance_from_end,
                "nh_max": self.config.quality.nh_max,
                "nm_max": self.config.quality.nm_max,
                "compute_tn5": self.config.compute_tn5,
